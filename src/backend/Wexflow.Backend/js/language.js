const languageModule = (function () {
    ...
    const codes = [
        ...
        { Name: "中文", Code: "cn", Icon: "images/cn.png" }
   ];
    ...
    // cn
    //
    languages["cn"]["language"] ="语言";
    languages["cn"]["help"] = "帮助";
    languages["cn"]["about"] = "关于";
    languages["cn"]["username"] = "用户名";
    languages["cn"]["password"] = "密码";
    languages["cn"]["forgot-password"] = "忘记密码？";
    languages["cn"]["login"] = "登录";
    languages["cn"]["valid-username"] = "输入有效的用户名和密码。";
    languages["cn"]["wrong-credentials"] = "凭据错误。";
    languages["cn"]["wrong-password"] = "密码不正确。";
    languages["cn"]["submit"] = "提交";
    languages["cn"]["enter-username"] = "输入用户名。";
    languages["cn"]["fp-error"] = "发送电子邮件时发生错误。";
    languages["cn"]["fp-success"] = "带有新密码的电子邮件已发送至：";
    languages["cn"]["lnk-dashboard"] = "仪表板";
    languages["cn"]["lnk-manager"] = "管理";
    languages["cn"]["lnk-designer"] = "设计";
    languages["cn"]["lnk-history"] = "历史";
    languages["cn"]["lnk-users"] = "用户";
    languages["cn"]["lnk-profiles"] = "个人资料";
    languages["cn"]["spn-logout"] = "登出";
    languages["cn"]["status-pending-label"] = "待处理";
    languages["cn"]["status-running-label"] = "正在运行";
    languages["cn"]["status-done-label"] = "完成";
    languages["cn"]["status-failed-label"] = "失败";
    languages["cn"]["status-warning-label"] = "警告";
    languages["cn"]["status-disapproved-label"] = "拒绝";
    languages["cn"]["status-stopped-label"] = "已停止";
    languages["cn"]["lbl-show"] = "显示";
    languages["cn"]["lbl-entries"] = "条目";
    languages["cn"]["spn-entries-count-label"] = "总条目：";
    languages["cn"]["lbl-from"] = "从";
    languages["cn"]["lbl-to"] = "至";
    languages["cn"]["btn-search"] = "搜索";
    languages["cn"]["new-user-action"] = "新的用户";
    languages["cn"]["save-action"] = "保存";
    languages["cn"]["delete-action"] = "删除";
    languages["cn"]["tr-createdOn-label"] = "创建于";
    languages["cn"]["tr-modifiedOn-label"] = "修改于";
    languages["cn"]["userprofile-slct-label"] = "用户资料";
    languages["cn"]["email-text-label"] = "电子邮件";
    languages["cn"]["change-password"] = "更改密码";
    languages["cn"]["old-password-text-label"] = "旧密码";
    languages["cn"]["lbl-new-password"] = "新密码";
    languages["cn"]["confirm-password-text-label"] = "确认密码";
    languages["cn"]["wf-start"] = "开始";
    languages["cn"]["wf-pause"] = "暂停";
    languages["cn"]["wf-resume"] = "恢复";
    languages["cn"]["wf-stop"] = "停止";
    languages["cn"]["wf-approve"] = "批准";
    languages["cn"]["wf-reject"] = "拒绝";
    languages["cn"]["op-not-supported"] = "不支持此操作。";
    languages["cn"]["job-part-1"] = "作业 ";
    languages["cn"]["job-approved"] = " 被批准了。";
    languages["cn"]["job-rejected"] = " 被拒绝。";
    languages["cn"]["workflows-server-error"] = "检索工作流时发生错误。请检查Wexflow服务器是否正常运行。";
    languages["cn"]["job-approved-error-part-1"] = "审批作业时发生错误";
    languages["cn"]["job-rejected-error-part-1"] = "拒绝作业时发生错误";
    languages["cn"]["job-approved-error-part-2"] = "作业流程";
    languages["cn"]["th-wf-id"] = "ID";
    languages["cn"]["th-wf-n"] = "名称";
    languages["cn"]["th-wf-lt"] = "启动类型";
    languages["cn"]["th-wf-e"] = "启用";
    languages["cn"]["th-wf-a"] = "审批";
    languages["cn"]["th-wf-d"] = "描述";
    languages["cn"]["th-job-id"] = "作业ID";
    languages["cn"]["th-job-startedOn"] = "开始于";
    languages["cn"]["browse"] = "浏览";
    languages["cn"]["diagram"] = "图解";
    languages["cn"]["graph"] = "图形";
    languages["cn"]["json"] = "JSON";
    languages["cn"]["xml"] = "XML";
    languages["cn"]["export"] = "导出";
    languages["cn"]["import"] = "导入";
    languages["cn"]["newworkflow"] = "新工作流程";
    languages["cn"]["searchtasks"] = "搜索任务";
    languages["cn"]["task-id"] = "ID";
    languages["cn"]["task-desc"] = "描述";
    languages["cn"]["task-enabled"] = "启用";
    languages["cn"]["btn-new-setting"] = "新设置";
    languages["cn"]["wf-remove-setting"] = "删除";
    languages["cn"]["task-doc"] = "打开任务文档";
    languages["cn"]["task-settings"] = "任务设置";
    languages["cn"]["wf-settings-label"] = "工作流程设置";
    languages["cn"]["savehelp"] = "使用 Ctrl+S 保存。";
    languages["cn"]["wfid-label"] = "ID";
    languages["cn"]["wfname-label"] = "名称";
    languages["cn"]["wfdesc-label"] = "描述";
    languages["cn"]["wflaunchtype-label"] = "启动类型";
    languages["cn"]["wfperiod-label"] = "周期";
    languages["cn"]["wfcronexp-label"] = "Cron表达式";
    languages["cn"]["wfenabled-label"] = "启用";
    languages["cn"]["wfapproval-label"] = "审批";
    languages["cn"]["wfenablepj-label"] = "启用并行作业";
    languages["cn"]["wf-local-vars-label"] = "局部变量";
    languages["cn"]["wf-add-var"] = "新变量";
    languages["cn"]["removeblock"] = "删除任务";
    languages["cn"]["removeworkflow"] = "删除工作流程";
    languages["cn"]["wf-remove-var"] = "删除";
    languages["cn"]["confirm-delete-tasks"] = "您确定要删除所有任务吗？";
    languages["cn"]["confirm-delete-workflow"] = "确定要删除此工作流程吗？";
    languages["cn"]["confirm-delete-setting"] = "确定要删除此设置吗？";
    languages["cn"]["confirm-delete-task"] = "确定要删除此任务吗？";
    languages["cn"]["confirm-cron"] = "cron表达式格式无效。\n请阅读文档。";
    languages["cn"]["confirm-delete-var"] = "确定要删除此变量吗？";
    languages["cn"]["confirm-delete-workflows"] = "确定要删除选定的工作流程吗？";
    languages["cn"]["toast-task-names-error"] = "检索任务名称时发生错误。";
    languages["cn"]["toast-workflow-id-error"] = "获取新的工作流ID时发生错误。";
    languages["cn"]["toast-workflow-deleted"] = "工作流已成功删除。";
    languages["cn"]["toast-workflow-delete-error"] = "删除工作流时发生错误。";
    languages["cn"]["toast-settings-error"] = "检索设置时发生错误。";
    languages["cn"]["toast-save-workflow-diag"] = "从图视图成功保存和加载工作流程。";
    languages["cn"]["toast-save-workflow-diag-error"] = "从图视图保存工作流程时发生错误。";
    languages["cn"]["toast-workflow-name"] = "为此工作流输入名称。";
    languages["cn"]["toast-workflow-launchType"] = "为此工作流选择启动类型。";
    languages["cn"]["toast-workflow-period"] = "输入此工作流程的期限。";
    languages["cn"]["toast-workflow-cron"] = "为此工作流输入一个cron表达式。";
    languages["cn"]["toast-workflow-period-error"] = "期间格式无效。有效格式为：dd.hh：mm：ss";
    languages["cn"]["toast-workflow-id"] = "工作流标识已在使用中。请输入另一个。";
    languages["cn"]["toast-workflow-id-error"] = "输入有效的工作流ID。";
    languages["cn"]["toast-save-workflow-json"] = "工作流已成功从JSON视图保存和加载。";
    languages["cn"]["toast-save-workflow-json-error"] = "从JSON视图保存工作流时发生错误。";
    languages["cn"]["toast-save-workflow-xml"] = "工作流已成功从XML视图保存和加载。";
    languages["cn"]["toast-save-workflow-xml-error"] = "从XML视图保存工作流时发生错误。";
    languages["cn"]["toast-graph-error"] = "检索图形时发生错误。";
    languages["cn"]["toast-graph-save-error"] = "您必须保存工作流程才能查看图形。";
    languages["cn"]["toast-workflows-deleted"] = "工作流已成功删除。";
    languages["cn"]["toast-workflows-delete-error"] = "删除工作流程时发生错误。";
    languages["cn"]["toast-workflows-delete-info"] = "选择要删除的工作流程。";
    languages["cn"]["toast-open-workflow-info"] = "选择要打开的工作流程。";
    languages["cn"]["toast-upload-error"] = "上传文件时发生错误：";
    languages["cn"]["toast-upload-success"] = "上传成功。";
    languages["cn"]["toast-upload-not-valid"] = "无效。";
    languages["cn"]["wf-open"] = "打开";
    languages["cn"]["wfs-delete"] = "删除";
    languages["cn"]["open-wfs-msg"] = "使用 Ctrl+O 打开此窗口。";
    languages["cn"]["search-workflows"] = "搜索工作流程";
    languages["cn"]["toast-user-deleted"] = "用户已成功删除。";
    languages["cn"]["toast-user-delete-error"] = "删除用户时发生错误。";
    languages["cn"]["toast-username"] = "输入用户名。";
    languages["cn"]["toast-userprofile"] = "选择该用户的用户个人资料。";
    languages["cn"]["toast-password"] = "输入一个密码。";
    languages["cn"]["toast-password-error"] = "密码不匹配。";
    languages["cn"]["toast-email-error"] = "输入一个有效的电子邮件地址。";
    languages["cn"]["toast-user-created"] = "成功创建了用户。";
    languages["cn"]["toast-user-create-error"] = "创建用户时发生错误。";
    languages["cn"]["toast-username-exists"] = "具有该名称的用户已经存在。键入另一个用户名。";
    languages["cn"]["toast-password-incorrect"] = "密码不正确。";
    languages["cn"]["toast-old-password-incorrect"] = "旧密码无效。";
    languages["cn"]["toast-new-password-error"] = "新密码不匹配。";
    languages["cn"]["toast-new-password"] = "输入新的密码。";
    languages["cn"]["toast-user-updated"] = "用户已成功更新。";
    languages["cn"]["toast-user-update-error"] = "更新用户时发生错误。";
    languages["cn"]["confirm-user-delete"] = "确定要删除此用户吗？";
    languages["cn"]["lnk-records"] = "记录";
    languages["cn"]["lnk-approval"] = "审批";
    languages["cn"]["search-notifications"] = "搜索通知";
    languages["cn"]["btn-delete-notification"] = "删除";
    languages["cn"]["btn-mark-as-unread"] = "标记为未读";
    languages["cn"]["btn-mark-as-read"] = "标记为已读";
    languages["cn"]["th-assigned-by"] = "分配人";
    languages["cn"]["th-assigned-on"] = "分配给";
    languages["cn"]["th-message"] = "信息";
    languages["cn"]["toast-select-notifications"] = "选择要删除的通知。";
    languages["cn"]["confirm-delete-notification"] = "确定要删除此通知吗？";
    languages["cn"]["confirm-delete-notifications"] = "您确定要删除这些通知吗？";
    languages["cn"]["search-records"] = "搜索记录";
    languages["cn"]["btn-delete-record"] = "删除";
    languages["cn"]["btn-new-record"] = "新纪录";
    languages["cn"]["record-information"] = "记录信息";
    languages["cn"]["edit-record-td-id"] = "ID";
    languages["cn"]["edit-record-td-name"] = "名称";
    languages["cn"]["edit-record-td-description"] = "描述";
    languages["cn"]["edit-record-td-approved"] = "已批准";
    languages["cn"]["edit-record-td-start-date"] = "开始日期";
    languages["cn"]["edit-record-td-end-date"] = "结束日期";
    languages["cn"]["edit-record-td-comments"] = "评论";
    languages["cn"]["edit-record-td-manager-comments"] = "经理评论";
    languages["cn"]["edit-record-td-created-by"] = "创建者";
    languages["cn"]["edit-record-td-created-on"] = "创建于";
    languages["cn"]["edit-record-td-modified-by"] = "修改者";
    languages["cn"]["edit-record-td-modified-on"] = "修改于";
    languages["cn"]["edit-record-td-assigned-to"] = "分配给";
    languages["cn"]["edit-record-td-assigned-on"] = "分配给";
    languages["cn"]["edit-record-td-versions"] = "版本";
    languages["cn"]["optional"] = " （可选的）";
    languages["cn"]["btn-upload-version"] = "上传";
    languages["cn"]["delete-version"] = "删除";
    languages["cn"]["record-save"] = "救";
    languages["cn"]["record-cancel"] = "取消";
    languages["cn"]["record-delete"] = "删除";
    languages["cn"]["latest-version"] = "最新版本";
    languages["cn"]["uploading"] = "正在上传...";
    languages["cn"]["toast-version-file-deleted"] = "版本文件已成功删除。";
    languages["cn"]["toast-version-file-delete-error"] =  "删除版本文件时发生错误。";
    languages["cn"]["toast-approvers-notified"] =  "审批人已通过此修改通知。";
    languages["cn"]["toast-approvers-notify-error"] =  "在通知记录者时出错。";
    languages["cn"]["toast-assigned-to-notified"] =  "分配给该记录的用户已通过此修改通知。";
    languages["cn"]["toast-assigned-to-notify-error"] =  "在通知分配给该记录的用户时发生错误。";
    languages["cn"]["toast-record-saved"] =  "记录已成功保存。";
    languages["cn"]["toast-record-save-error"] =  "保存记录时发生错误。";
    languages["cn"]["toast-modifications-canceled"] =  "修改已成功取消。";
    languages["cn"]["toast-modifications-cancel-error"] =  "取消修改时发生错误。";
    languages["cn"]["toast-select-records"] =  "选择要删除的记录。";
    languages["cn"]["toast-record-name"] =  "为此记录输入一个名称。";
    languages["cn"]["confirm-delete-record"] =  "您确定要删除此记录吗？";
    languages["cn"]["confirm-delete-records"] =  "您确定要删除这些记录吗？";
    languages["cn"]["record-name"] =  "名称";
    languages["cn"]["record-approved"] =  "已批准";
    languages["cn"]["record-start-date"] =  "开始日期";
    languages["cn"]["record-end-date"] =  "结束日期";
    languages["cn"]["record-assigned-to"] =  "分配给";
    languages["cn"]["record-assigned-on"] =  "分配给";
    languages["cn"]["edit-record-td-approvers"] =  "审批人";
    languages["cn"]["th-approved-by"] =  "审批者";
    languages["cn"]["th-approved"] =  "已审批";
    languages["cn"]["th-approved-on"] =  "审批";
